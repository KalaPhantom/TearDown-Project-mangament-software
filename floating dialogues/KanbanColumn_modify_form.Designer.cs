...
{
    partial class KanbanColumn_modify_form
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            Controls.Add(color5_btn);
            Controls.Add(color4_btn);
            Controls.Add(color3_btn);
            Controls.Add(color2_btn);
            ...
            Name = "KanbanColumn_modify_form";
            Text = "Modify Column";
            ((System.ComponentModel.ISupportInitialize)Column_color_pb).EndInit();
            ResumeLayout(false);
            PerformLayout();
        }
