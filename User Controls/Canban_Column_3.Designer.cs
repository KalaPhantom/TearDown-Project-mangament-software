namespace TearDown_Project_mangament_software.User_Controls
{
    partial class Canban_Column_3
    {
        ...
        private void InitializeComponent()
        {
            ...
            modify_column_btn.Location = new Point(269, 55);
