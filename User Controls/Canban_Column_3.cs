...
{
    public partial class Canban_Column_3 : UserControl
    {

        public const int Column_number = 3;
        public Canban_Column_3()
        {
            InitializeComponent();
            LoadDatafromColumn3();
            LoadCards();
        ...
        public static void PassDatafromColumn3()
        {
                ...
                {
                    column3 = saveCardData_fromColumn3()
                };
        ...
        public static void LoadCards()
        {
            ...
            {
                string jsonString = File.ReadAllText("KanbanColumn3_data.json");
                var boardData = JsonConvert.DeserializeObject<KanbanColumndata>(jsonString);

                LoadCards_to_flp(taskCards_flowlayoutPanel, boardData.column3);
            }
        ...
        private void SaveDatafromColumn3()
        {
            ...
            File.WriteAllText(@"Column3_data.json", json);
        }


        private void LoadDatafromColumn3()
        {
            if (File.Exists(@"Column3_data.json"))
            {
                string jsonString = File.ReadAllText(@"Column3_data.json");
